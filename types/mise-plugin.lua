...
---@field options? table Per-tool options from mise.toml ([tools."backend:tool"])
...
---@field download_path? string Scratch directory mise provides for downloads
---@field options? table Per-tool options from mise.toml
